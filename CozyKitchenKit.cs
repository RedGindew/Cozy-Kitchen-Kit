...
public class CozyKitchenKit : Mod
{
    ...
    {
        FurnitureType.Register(new FurnitureType.TypeSettings("CozyKitchenKit.CozyCounter", new Point(1, 1), ObjectCategory.Counter, 80)
        {
            Icon = this.Icon,
        ...
        FurnitureType.Register(new FurnitureType.TypeSettings("CozyKitchenKit.CozyFridge", new Point(1, 1), ObjectCategory.Fridge, 800)
        {
            Icon = this.Icon,
            Tab = (FurnitureTool.Tab.Kitchen),
        ...
        FurnitureType.Register(new FurnitureType.TypeSettings("CozyKitchenKit.CozyShelf", new Point(1, 1), ObjectCategory.NonColliding | ObjectCategory.WallHanging, 800)
        {
            Icon = this.Icon,
            Tab = (FurnitureTool.Tab.Kitchen),
        ...
        FurnitureType.Register(new FurnitureType.TypeSettings("CozyKitchenKit.CozySink", new Point(1, 1), ObjectCategory.CounterObject | ObjectCategory.DisallowedOnGround | ObjectCategory.Sink, 350)
        {
            Icon = this.Icon,
            Tab = (FurnitureTool.Tab.Kitchen),
            Colors = new ColorSettings(ColorScheme.MutedPastels, ColorScheme.White){Defaults = new int[] { 3, 0 } },
        ...
        FurnitureType.Register(new FurnitureType.TypeSettings("CozyKitchenKit.CozyCabinet", new Point(1, 1), ObjectCategory.Nothing, 800)
        {
            Icon = this.Icon,
            Tab = (FurnitureTool.Tab.Kitchen),
